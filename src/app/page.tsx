            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  required
                  className="w-full pl-10 pr-3 py-3 bg-white border border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-400/50 focus:border-indigo-400/50 outline-none transition-all text-slate-900 font-medium placeholder-slate-400"
