  ...
  const sidebarContent = (
    <>
      <div className="mb-8 flex items-center gap-3">
        <div className="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center font-bold text-white shrink-0">M</div>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="md:hidden sticky top-0 z-40 bg-slate-900 text-white flex items-center justify-between px-4 py-3 shadow-lg">
        ...
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-md bg-emerald-500 flex items-center justify-center font-bold text-white text-xs">M</div>
      ...
      {sidebarOpen && (
        <div className="md:hidden fixed inset-0 z-50">
          <div 
            ...
            onClick={() => setSidebarOpen(false)}
          />
          <aside className="sidebar-drawer absolute left-0 top-0 bottom-0 w-72 bg-slate-900 text-white p-5 flex flex-col overflow-y-auto">
      ...
      <div className="flex">
        {/* Desktop sidebar */}
        <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-slate-900 text-white p-5">
          {sidebarContent}
        </aside>
